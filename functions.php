...
function chinese_add_stylesheets(){
    ...
    wp_enqueue_style( 'fontawesome', get_template_directory_uri().'/css/font-awesome.min.css','','','all' );

    wp_enqueue_style( 'lato', get_template_directory_uri().'/fonts/Lato-Font/stylesheet.css','','','all' );

    wp_enqueue_style( 'chinese-fontello', get_template_directory_uri().'/fonts/Ketchup-Font/css/fontello.css','','','all' );

    wp_enqueue_style( 'chinese-fontello-embedded', get_template_directory_uri().'/fonts/Ketchup-Font/css/fontello-embedded.css','','','all' );

    wp_enqueue_style( 'chinese-fontello-codes', get_template_directory_uri().'/fonts/Ketchup-Font/css/fontello-codes.css','','','all' );



    /*************************************************************************/

    wp_enqueue_style('animate',get_template_directory_uri().'/css/animate.min.css','','all');

    wp_enqueue_style('chinese-blog',get_template_directory_uri().'/css/chinese-blog.css','','all');

    wp_enqueue_style('slicknav',get_template_directory_uri().'/css/slicknav.css','','all');

    wp_enqueue_style('magnificpopupcss',get_template_directory_uri().'/css/magnific-popup.css','','all');
...
function chinese_add_scripts(){
    ...
    wp_enqueue_script('chinese-bootstrap', get_template_directory_uri().'/js/bootstrap.min.js',
        array('jquery'),'',true);
    ...
    *******************----- Scripts ----******************************/
    ...
    wp_enqueue_script('slicknav', get_template_directory_uri()
        .'/js/jquery.slicknav.min.js',
        array('jquery'),'',true);


    wp_enqueue_script('imagesloaded', get_template_directory_uri()
        .'/js/imageloaded.pkgd.min.js',
        array('jquery'),'',true);


    wp_enqueue_script('matchHeight', get_template_directory_uri()
        .'/js/jquery.matchHeight-min.js',
        array('jquery'),'',true);


    wp_enqueue_script('magnificpopupjs', get_template_directory_uri()
        .'/js/jquery.magnific-popup.min.js',
        array('jquery'),'',true);


    wp_enqueue_script('chinese-theme-js', get_template_directory_uri()
        .'/js/init.js',
        array('jquery'),'',true);
}
...
if(!function_exists('chinese_comment')):
    function chinese_comment($comment, $args, $depth) {
        ...
        <div class="comment-author vcard">
            ...
            <?php printf( __( '<cite class="fn">%s</cite> <span class="says">says:</span>','chinese-restaurant' ), get_comment_author_link() ); ?>
