...
Chinese Restaurant WordPress Theme uses bootstrap responsive design that is mainly targeted for Chinese, Japanese, Korean, Thai restaurants.
...
- FontAwesome v4.7.0 by @davegandy - http://fontawesome.io - @fontawesome License - http://fontawesome.io/license (Font: SIL OFL 1.1, CSS: MIT License)
...
- TGM Plugin Activation version 2.6.1 class by Thomas Griffin is licensed under MIT license.
...
* Removed style/script handles from external scripts
* Corrected all script errors
