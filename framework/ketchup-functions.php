<?php
add_action( 'tgmpa_register', 'chinese_restaurant_register_required_plugins' );
function chinese_restaurant_register_required_plugins() {
    /*
    ...
    $config = array(
        'id'           => 'chinese-restaurant',                 // Unique ID for hashing notices for multiple instances of TGMPA.
...
function chinese_customizer($wp_customize)
{
    ...
    $wp_customize->add_panel('chinese_typography_panel', array(
        ...
        'description' => __('Description of what this panel does.', 'chinese-restaurant'),
    ));
